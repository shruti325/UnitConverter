    ...
    double convert(double number){
        switch(selectedUnitFrom){
            case 0: switch (selectedUnitTo){
                ...
                case 1: return number*60;
                case 2: return number*3600;
            }
            case 1: switch (selectedUnitTo){
                case 0: return number/60;
                case 1 : return number;
                case 2 : return number*60;
            }
            case 2: switch (selectedUnitTo){
                case 0: return number/3600;
                case 1: return number/60;
    ...
    void  convertInputToSelectedUnit(){
        ...
        if (!text.isEmpty()){
            try {
                ...
                Toast.makeText(TimeConverterActivity.this, "Invalid input.", Toast.LENGTH_SHORT).show();
            }
