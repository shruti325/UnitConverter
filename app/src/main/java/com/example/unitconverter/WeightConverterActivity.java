    ...
    double convert(double number){
        switch(selectedUnitFrom){
            case 0: switch (selectedUnitTo){
                ...
                case 2: return number*2.205;
            }
            case 1: switch (selectedUnitTo){
                case 0: return number/1000;
                case 1 : return number;
                case 2 : return number*0.002205;
            }
            case 2: switch (selectedUnitTo){
                case 0: return number/2.205;
                case 1: return number/2205;
    ...
    void  convertInputToSelectedUnit(){
        ...
        if (!text.isEmpty()){
            try {
                ...
                Toast.makeText(WeightConverterActivity.this, "Invalid input.", Toast.LENGTH_SHORT).show();
            }
