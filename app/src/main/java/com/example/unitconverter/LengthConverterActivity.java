    ...
    double convert(double number){
        switch(selectedUnitFrom){
            case 0: switch (selectedUnitTo){
                ...
                case 1: return number/39.37;
                case 2: return number*2.54;
            }
            case 1: switch (selectedUnitTo){
                case 0: return number*39.37;
                case 1 : return number;
                case 2 : return number*100;
            }
            case 2: switch (selectedUnitTo){
                case 0: return number/2.54;
                case 1: return number/100;
    ...
    void  convertInputToSelectedUnit(){
        ...
        if (!text.isEmpty()){
            try {
                ...
                Toast.makeText(LengthConverterActivity.this, "Invalid input.", Toast.LENGTH_SHORT).show();
            }
